...
// She could follow the following two paths: 0-->2-->4-->6 or 0-->2-->3-->6 . The first path takes  jumps while the second takes .
...
// Input Format --> Is an array that  contains n  space-separated binary integers describing clouds c[i]  where 0 <= i <= n.
